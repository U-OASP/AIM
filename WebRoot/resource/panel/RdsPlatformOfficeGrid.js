 ...
 * 座位管理
 */
Ext.define("Rds.panel.RdsPlatformOfficeGrid",{
	...
	initComponent:function(){
		...
		me.store = Ext.create('Ext.data.Store',{
			fields:['id','officename','seatname'],
			proxy: {
                type: 'ajax',
                actionMethods:{read:'POST'},
				url: basepath+'platform/office/queryplatformseatspage.do',
                params:{
                },
                reader: {
                    type: 'json',
		...
		var win = Ext.create("Ext.window.Window",{
			...
			buttons:[{
				...
				handler:function(){
					var form = win.down("form");
					form.submit({  
					    url : basepath+"platform/office/insertSeat.do",  
					    baseParams : { 
					    },  
					    waitMsg : '正在提交数据',  
					    waitTitle : '提示',  
