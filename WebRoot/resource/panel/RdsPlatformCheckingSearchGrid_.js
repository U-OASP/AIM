	...
	initComponent:function(){
        ...
        var users = Ext.create("Ext.form.field.ComboBox",{
            ...
            store: new Ext.data.Store({ 
                ...
                fields:['userid', 'username'], //不管有没有model，这个fields都必须写，而且只能写在这里，
                autoLoad:true 
		...
		me.store = Ext.create('Ext.data.Store',{
			fields:['userid','username','total'],
			proxy: {
                type: 'ajax',
                actionMethods:{read:'POST'},
				url: basepath+'platform/checking/queryplatformcheckingtotal.do',
                params:{
                },
                reader: {
                    type: 'json',
...
//                      Ext.create("Ext.grid.RowNumberer",{text: '序号',width:39,align:'center'}),
                        {text: "人员名称",  dataIndex: 'username',width:120},
	      				{text: "全勤天数", dataIndex: 'total',width:200}];
