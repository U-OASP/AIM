 ...
 * 休假申请
 */
Ext.define("Rds.panel.RdsPlatformVacationGrid",{
			...
			items : [{
            	...
            	listeners: {
                    click: function(){
                		...
                		console.log(record.get("reguser"));
            	...
            	listeners: {
                    click: function(){
                		...
                		Ext.Ajax.request({  
                    	       url: basepath+"platform/vacation/delete.do",  
                    	       method: "POST",
                    	       params: { 
                    	    	   "ids":codes
                    	       },
		...
		var win = Ext.create("Ext.window.Window",{
			...
			buttons:[{
				...
				handler:function(){
					...
					form.submit({  
					    url : basepath+"platform/vacation/update.do",  
					    baseParams : { 
					    },  
					    waitMsg : '正在提交数据',  
					    waitTitle : '提示',  
