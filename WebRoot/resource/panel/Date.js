...
Ext.define('Rds.panel.Date', {
    ...
    alias: 'widget.rdsdatepicker',
    //alternateClassName: 'Ext.RdsDatePicker',
    ...
    fullUpdate: function(date){
        ...
        for(; i < me.numDays; ++i) {
            ...
            var value = data[current.getDate() + 1];
            var cs = "";
...
//            console.log(previousMonth.getFullYear()+"-"+previousMonth.getMonth()+"-"+(current.getDate() + 1));
            
            setCellClass(cells[i], cls+cs);
        }
